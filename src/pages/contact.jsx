...
const TerminalHeader = () => {
  return (
    <div className="w-full p-3 bg-slate-900 flex items-center gap-1 sticky top-0">
      ...
      <span className="text-sm text-slate-200 font-semibold absolute left-[50%] -translate-x-[50%] tracking-wide">
        team@prsm.llc
      </span>
    </div>
  );
...
const TerminalBody = ({ containerRef, inputRef }) => {
  ...
  return (
    <div className="terminalScrollbar p-2 text-slate-100 text-lg">
      <InitialText />
